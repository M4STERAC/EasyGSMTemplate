...
import { addServer } from '../../../store/reducers/server';
...
const AddServerPg2 = ({ game, name, savePath, executablePath, setOpenAddServer }) => {
      ...
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          try {
            ...
            const server = { ...state, banlist, ports };

            dispatch(addServer({ server }));
            setOpenAddServer(false);
            FireStore.addServer(server);
...
AddServerPg2.propTypes = {
  game: PropTypes.string,
  name: PropTypes.string,
  savePath: PropTypes.string,
  executablePath: PropTypes.string,
  setOpenAddServer: PropTypes.func
};

export default AddServerPg2;
